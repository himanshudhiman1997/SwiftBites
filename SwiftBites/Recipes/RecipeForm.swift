...
struct RecipeForm: View {
    ...
    @Query private var recipes: [Recipe] // SwiftData @Query for recipes
    @Query private var categories: [Category] // SwiftData @Query for categories
    ...
    private func ingredientPicker() -> some View {
        IngredientsView { selectedIngredient in
            let recipeIngredient = RecipeIngredient(id: UUID(), ingredient: selectedIngredient, quantity: "")
    ...
    func delete(recipe: Recipe) {
        ...
        do {
            try modelContext.save() // Save changes to apply deletions
        } catch {
    ...
    func addRecipe(name: String, summary: String, category: Category?, serving: Int, time: Int, ingredients: [RecipeIngredient], instructions: String, imageData: Data?) {
        
        let recipeId = UUID()
        
        let recipe = Recipe(id: recipeId, name: name, summary: summary, serving: serving, time: time, instructions: instructions, imageData: imageData, category: category)
        
        //writing this separately for maintaining the relationship
        recipe.ingredients = ingredients
